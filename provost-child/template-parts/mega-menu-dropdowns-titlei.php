				<div class="dropDownColumn">
					...
					?>
						<h2><img src="https://provost.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/policy.svg" alt="" />Title I Information</h2>
					<?php
					} else {
					?>
						<h3><img src="https://provost.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/policy.svg" alt="" />Title I Information</h3>
					<?php
					}
					?>
					<ul>
				...
				<div class="dropDownColumn">
					...
					if (is_page('title-i') || in_array(623, get_post_ancestors($post))) {
					?>
						<h2><img src="https://provost.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/procedures1.svg" alt="" />School Parent Family Compact</h2>
					<?php
					} else {
					?>
						<h3><img src="https://provost.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/procedures1.svg" alt="" />School Parent Family Compact</h3>
					<?php
					}
					?>
					...
					if (is_page('title-i') || in_array(623, get_post_ancestors($post))) {
					?>
						<h2><img src="https://provost.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/policy.svg" alt="" />Parent &amp; Family Engagement Policy</h2>
					<?php
					} else {
					?>
						<h3><img src="https://provost.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/policy.svg" alt="" />Parent &amp; Family Engagement Policy</h3>
					<?php
					}
					?>
				...
				<div class="dropDownColumn">
					...
					if (is_page('title-i') || in_array(623, get_post_ancestors($post))) {
					?>
						<h2><img src="https://provost.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/policy.svg" alt="" />Additional Resources</h2>
					<?php
					} else {
					?>
						<h3><img src="https://provost.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/policy.svg" alt="" />Additional Resources</h3>
					<?php
					}
					?>
