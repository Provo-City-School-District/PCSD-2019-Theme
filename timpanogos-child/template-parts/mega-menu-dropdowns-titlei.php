			...
			<div class="dropDownColumn">
				...
				if (is_page('title-i') || in_array(623, get_post_ancestors($post))) {
				?>
					<h2><img src="https://timpanogos.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/policy.svg" alt="" />Parent-School Learning Compact</h2>
				<?php
				} else {
				?>
				...
				<ul>
					<li class="pdf"><a href="https://timpanogos.provo.edu/wp-content/uploads/2022/08/TIMP_ParentCompact_fy23_Eng.pdf">Parent-School Learning Compact (English)</a></li>
					<li class="pdf"><a href="https://timpanogos.provo.edu/wp-content/uploads/2022/08/TIMP_ParentCompact_fy23_Spa.pdf">Parent-School Learning Compact (Spanish)</a></li>
				</ul>
				<?php
				//checks if this template section is loading into the menu or into the sidebar/content area and assigns the proper heading
				if (is_page('title-i') || in_array(623, get_post_ancestors($post))) {
				?>
					<h2><img src="https://timpanogos.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/policy.svg" alt="" />Parent Engagement Policy</h2>
				<?php
				} else {
				?>
				...
				<ul>
					<li class="pdf"><a href="https://timpanogos.provo.edu/wp-content/uploads/2022/08/TIMP_ParentEngagementPolicy_fy23_Eng.pdf">Parent Engagement Policy (English)</a></li>
					<li class="pdf"><a href="https://timpanogos.provo.edu/wp-content/uploads/2022/08/TIMP_ParentEngagementPolicy_fy23_Spa.pdf">Parent Engagement Policy (Spanish)</a></li>
				</ul>
			</div>
			<div class="dropDownColumn">
				<?php
