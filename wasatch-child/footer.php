<footer id="mainFooter">
			<section id="teacherAccess">
				...
				<ul class="imagelist">
				 	...
				 	<li><a href="<?php echo get_home_url(); ?>/how-to-schedule-a-substitute/"><img src="<?php echo get_template_directory_uri(); ?>/assets/icons/find-a-substitute.svg" alt="" />Absence Management System</a></li>
