...
<html <?php language_attributes();?>>
	<head>
		<!-- Global site tag (gtag.js) - Google Analytics -->
			<script async src="https://www.googletagmanager.com/gtag/js?id=UA-130781213-1"></script>
			<script>
			  window.dataLayer = window.dataLayer || [];
			  function gtag(){dataLayer.push(arguments);}
			  gtag('js', new Date());
			
			  gtag('config', 'UA-130781213-1');
			</script>
	...
	<body>
		...
		<header id="mainHeader">
			...
			<h1>Franklin Elementary School</h1>
			</a>
				<aside>
					<ul class="sociallinks">
						<li><a href="http://www.instagram.com/franklin_elem/"><img src="<?php echo get_template_directory_uri() .'/assets/icons/socialmedia-instagram-white.svg' ?>" alt="Link to Instagram" /></span>
							</a>
						</li>
						<li><a href="https://twitter.com/@Franklin_Elem"><img src="<?php echo get_template_directory_uri() .'/assets/icons/socialmedia-twitter-white.svg' ?>" alt="Link to Twitter" /></span>
							</a>
						</li>
						<li><a href="http://www.facebook.com/FranklinElementarySchool"><img src="<?php echo get_template_directory_uri() .'/assets/icons/socialmedia-facebook-white.svg' ?>" alt="Link to Facebook" /></span>
							</a>
						</li>
					</ul>
					<!-- Search Form -->
					...
					<ul class="contactinfo" itemscope itemtype="https://schema.org/PostalAddress">
						<li><span itemprop="streetAddress">350 South 600 West</span><span itemprop="addressLocality"> Provo</span>, <span itemprop="addressRegion">Utah</span> <span itemprop="postalCode">84601</span><span class="phone" itemprop="telephone"> Phone: (801) 374-4925</span><span class="fax" itemprop="faxNumber"> Fax: (801) 374-4886 </span>
					</ul>
