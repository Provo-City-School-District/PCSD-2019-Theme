<footer id="mainFooter">
			<section id="teacherAccess">
				<h1 class="teacherActivate"><a href="https://independence.provo.edu/teacher-access/">Teacher Access</a></h1>
				...
				<ul class="imagelist">
				 	...
				 	<li><a href="https://login.frontlineeducation.com/login?signin=c4f172530351d39768e7d4ddf134db58&productId=ABSMGMT&clientId=ABSMGMT#/login"><img src="https://timpview.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/find-a-substitute.svg" alt="" />Absence Management System</a></li>
	...
	?>
		...
		(function () {
		    var cludoSettings = {
		        customerId: 10000352,
		        engineId: 10000520,
		        searchUrl: 'https://independence.provo.edu/search-results/',
		        language: 'en',
